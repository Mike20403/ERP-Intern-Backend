...
{
    public sealed class RemoveOwnerHandler : BaseRequestHandler<RemoveOwner, DataChanged<Card>>
    {
        ...
        public override async Task<DataChanged<Card>> Process(RemoveOwner request, CancellationToken cancellationToken)
        {
